    ...
    return (
        <div className='searchPage'>
            <div className='searchPage__info'>
                <p>
                30 stays &middot; 25 may to 30 may 	&middot; 2 guest
                </p>
                <h1>
                    Stays Nearby
                </h1>
            ...
            <SearchResult
                ...
                location="Private room in center of Goa"
                title="30 mins to Oxford Street, Excel Goa"
                description="1 guest · 1 bedroom · 1 bed · 1.5 shared bathrooms · Wifi · Kitchen · Free parking · Washing Machine"
                star={4.1}
                price="Rs.550 / night"
                total="Rs.1000 total"
            />
            <SearchResult
                img="https://media.cntraveler.com/photos/5a8f258bd363c34048b35aac/master/w_2250,h_1500,c_limit/airbnb-plus-Goa.jpg"
                location="Private room in center of Goa"
